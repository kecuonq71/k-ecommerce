                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto"
                                            src="{{ asset('storage/uploads/products/' . $product->image) }}" width="474"
                                            height="474" alt="{{ $product->name }}" />
                                    ...
                                    @if (!@empty($gallery))
                                        @foreach ($gallery as $gal)
                                            <div class="swiper-slide product-single__image-item">
                                                <img loading="lazy" class="h-auto"
                                                    src="{{ asset('storage/uploads/products/thumbnails/' . $gal) }}"
                                                    width="674" height="674" alt="" />
                                                <a data-fancybox="gallery"
                                                    href="{{ asset('storage/uploads/products/thumbnails/' . $gal) }}"
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ asset('storage/uploads/products/' . $product->image) }}"width="104"
                                            height="104" alt="" /></div>
                                    @php
                                        $gallery = json_decode($product->gallery, true);
                                    @endphp
                        ...
                        @foreach ($relatedProducts as $relatedProduct)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.detail', $relatedProduct->slug) }}">
                                        <img loading="lazy"
                                            src="{{ asset('storage/uploads/products/' . $relatedProduct->image) }}"
                                            width="330" height="400" alt="{{ $relatedProduct->name }}"
                                            class="pc__img">
                                        @php
                                            $gallery = json_decode($relatedProduct->gallery, true);
                                        @endphp
                                        @if (!@empty($gallery))
                                            @foreach ($gallery as $gal)
                                                <img loading="lazy"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.detail', $relatedProduct->slug) }}">{{ $relatedProduct->name }}</a>
                                    </h6>
