        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Category Detail</div>
                    </li>
                </ul>
            </div>
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.category.update', $category) }}"
                        ...
                        <div class="upload-image flex-grow">
                            @if (!@empty($category->image))
                                <div class="item" id="imgpreview" style="display:block">
                                    <img src="{{ asset('storage/uploads/categories/' . $category->image) }}" class="effect8"
                                        alt="Category Image">
                                </div>
                            @else
